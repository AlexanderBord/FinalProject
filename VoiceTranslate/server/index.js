...
//connect to whatsApp function, create a whatsapp client by scannig a qr code
function connectToWhatsApp(){ 
  ...
  async function start(client) {
    ...
    socket.emit("contactsSorted", contactsSorted);
}
  create({
    headless: true,
    qrTimeout: 0,
...
//get home route, returns response of html site of the application contains dynamic qr code
...
</head> <body class="is-boxed has-animations">
<div class="body-wrap">
    ...
    <main>
        ...
        <div class="hero-copy">
                      <h1 class="hero-title mt-0">Please scan the qr code below with WhatsApp qr code scanner</h1>
                        <img id="qrImage" src=${QR} alt="qr code" width="600" height="600">
        </div>
    ...
    <a href="#">
      <img class="header-logo-image" src="dist/images/logo.svg" alt="Logo">
            ...
            <ul class="footer-social-links list-reset">
                <li>
                    <a href="https://www.facebook.com/harel.savitzky">
            ...
            <div class="footer-copyright">&copy; 2022 A.H , all rights reserved</div>
        </div>
    </div>
</footer>
